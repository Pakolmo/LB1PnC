	...
	(method (handleEvent event &tmp temp0)
			...
			(
				(and
					...
					(if (ClickedInRect 0 317 183 189 event) ;exit room down
					(event claimed: TRUE)
					(switch theCursor
						(999
...
;;;							
					...
					(if (ClickedInRect 0 4 178 189 event) ;exit room left
					(event claimed: TRUE)
					(switch theCursor
						(999
...
;;;							
					...
					(if (ClickedInRect 313 319 48 189 event) ;exit room right
					(event claimed: TRUE)
					(switch theCursor
						(999

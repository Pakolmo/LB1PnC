	...
	(method (handleEvent event &tmp temp0)
			...
			(
				(and
					...
					(if (ClickedInRect 3 3 113 189 event) ;exit room left
					(event claimed: TRUE)
					(switch theCursor
						(999
...
;;;							
					...
					(if (ClickedInRect 2 317 184 189 event) ;exit room down
					(event claimed: TRUE)
					(switch theCursor
						(999
...
;;;							
					...
					(if (ClickedInRect 312 319 135 189 event) ;exit room right
					(event claimed: TRUE)
					(switch theCursor
						(999
